...
**最終更新**: 2026-05-23 (Sprint 2.7.5 land)
...
- **Local DB**: expo-sqlite (migration head **v38**、 14 sprint 連続無変更 ✨)
...
- Sprint 2.7.5 — N=**TBD** (本 sprint、 ship docs accuracy review)
...
| **2.7** Hardening fan-out + ship | **進行中 (5/6)** | 6 (2.7.1-2.7.6) | LLMClient recon + Drafting 173 fan-out (7/7 EFs) + orphan cleanup + ship docs + milestone | `acd2b78` (Sprint 2.7.4) |
| **2.7c** Exercises master seed | ⏸ Phase 2.7 完了後 | 8-12 turn 想定 | Drafting 143 = 580 件 exercise seed (v38 `'exercise'` enum 既 future-proof) | — |
...
## 5. Drafting candidates 117-176 (59 件) architecture map

Drafting は v1.4 期に 116 件まで chat-side で numbered、 v1.5 で 117-176 (59 件、 security + workflow integrity 関連は inflation 抑制対象外で積極 propose 想定)。
...
| **162** | Incremental migration / 不要な migration avoidance | Phase 2.4-2.7 全期 | **14 sprint 連続 migration head v38 維持** (literal 実証) |
...
- Migration head **v38、 14 sprint 連続無変更** (Drafting 162)
...
- **Exercises master 580 件** (Phase 2.7c で完結予定、 Drafting 143 = workout 系の database 強化)
