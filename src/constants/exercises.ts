...
export const EXERCISES: ExerciseDefinition[] = [
  ...
  { id: 'ex_c026', nameJa: 'インドアサイクリングクラス', nameEn: 'Indoor Cycling Class', muscleGroup: 'full_body', secondaryMuscles: null, equipment: 'machine', sortOrder: 125, exerciseType: 'cardio', metValue: 8.5 },
  ...
  { id: 'ex_o037', nameJa: 'クアドラペッドフロー', nameEn: 'Quadruped Flow', muscleGroup: 'full_body', secondaryMuscles: null, equipment: 'bodyweight', sortOrder: 336, exerciseType: 'other', metValue: 5.0 },
  ...
  { id: 'ex_o047', nameJa: 'バランスドームトレーニング', nameEn: 'Balance Dome Training', muscleGroup: 'full_body', secondaryMuscles: ['core'], equipment: 'other', sortOrder: 346, exerciseType: 'other', metValue: 4.0 },
