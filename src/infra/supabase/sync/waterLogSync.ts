...
const SERVER_TABLE = 'user_water_logs';
const LOCAL_TABLE = 'water_logs';
...
async function applyServerRow(
  ...
  await db.runAsync(
    `INSERT INTO water_logs (
       id, user_id, amount_ml, logged_at, updated_at, synced_at
     )
     VALUES (?, ?, ?, ?, ?, datetime('now'))
...
export const waterLogSync: ResourceSyncModule = {
