...
const SERVER_TABLE = 'user_meal_logs';
const LOCAL_TABLE = 'meal_logs';
...
async function applyServerRow(
  ...
  await db.runAsync(
    `INSERT INTO meal_logs (
       id, profile_id, date, meal_type, updated_at, synced_at
     )
     VALUES (?, ?, ?, ?, ?, datetime('now'))
...
export const mealLogSync: ResourceSyncModule = {
